...
(function ($) {
    ...
    $.fn.storymap = function(options) {
        ...
        var defaults = {
            ...
            legend: false,
            createMap: function () {
                var map = L.map('map',{zoomControl:false, scrollWheelZoom:true, doubleClickZoom:true, minZoom: 4, maxZoom:6}).setView([44.1347254, -122.7411479], 4);
        ...
        var makeStoryMap = function (element, scenes, layers) {
            ...
            downBtn.click(function () {
                window.scrollBy(0, $(window).height() / 1.5);
            });
